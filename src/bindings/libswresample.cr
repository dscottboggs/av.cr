...
module AV
  lib LibSWResample
    ...
    fun alloc_set_opts = swr_alloc_set_opts(SwrContext*, Int64, LibAVUtil::SampleFormat, LibC::Int, Int64, LibAVUtil::SampleFormat, LibC::Int, LibC::Int, Void*) : SwrContext*
    fun free = swr_free(SwrContext**) : Void
    fun close = swr_close(SwrContext*) : Void
    fun convert = swr_convert(SwrContext*, UInt8**, LibC::Int, UInt8**, LibC::Int) : LibC::Int
    ...
    fun get_delay = swr_get_delay(SwrContext*, Int64) : Int64
    ...
    fun convert_frame = swr_convert_frame(SwrContext*, LibAVUtil::Frame*, LibAVUtil::Frame*) : LibC::Int
    fun config_frame = swr_config_frame(SwrContext*, LibAVUtil::Frame*, LibAVUtil::Frame*) : LibC::Int
  end
end
