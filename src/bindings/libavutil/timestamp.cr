...
module AV
  lib LibAVUtil
    ...
    fun ts_make_string = av_ts_make_string(LibC::Char*, Int64T) : LibC::Char*
    fun ts_make_time_string = av_ts_make_time_string(LibC::Char*, Int64T, LibAVUtil::Rational*) : LibC::Char*
  end
end
