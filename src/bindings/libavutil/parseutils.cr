module AV
  lib LibAVUtil
    ...
    fun parse_ratio = av_parse_ratio(Rational*, LibC::Char*, LibC::Int, LibC::Int, Void*) : LibC::Int
    fun parse_video_size = av_parse_video_size(LibC::Int*, LibC::Int*, LibC::Char*) : LibC::Int
    fun parse_video_rate = av_parse_video_rate(Rational*, LibC::Char*) : LibC::Int
    fun parse_color = av_parse_color(UInt8*, LibC::Char*, LibC::Int, Void*) : LibC::Int
    fun get_known_color_name = av_get_known_color_name(LibC::Int, UInt8**) : LibC::Char*
    fun parse_time = av_parse_time(Int64*, LibC::Char*, LibC::Int) : LibC::Int
